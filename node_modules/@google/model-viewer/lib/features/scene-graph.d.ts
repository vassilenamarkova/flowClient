...
export declare const $extraModels: unique symbol;
 ...
 */
export declare const SceneGraphMixin: <T extends Constructor<ModelViewerElementBase>>(ModelViewerElement: T) => Constructor<SceneGraphInterface> & T;
export {};
